...
trainimg = './data/datasets/MNIST/raw/train-images-idx3-ubyte'
trainlabel = './data/datasets/MNIST/raw/train-labels-idx1-ubyte'
testimg = './data/datasets/MNIST/raw/t10k-images-idx3-ubyte'
testlabel = './data/datasets/MNIST/raw/t10k-labels-idx1-ubyte'
trainfolder = './data/datasets/MNIST/imgs/train'
testfolder = './data/datasets/MNIST/imgs/test'
